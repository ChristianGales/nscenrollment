          ...
          <div class="col-md-12 mt-4">
              <div class="card">
                  <div class="card-header pb-0 px-3 d-flex align-items-center justify-content-between">
                      <h6 class="mb-0 me-3">Manage Subject</h6>
                      <div class="d-flex align-items-center">
                          ...
                          <a href="{{ route('admin.subject.create') }}" class="btn mb-0 bg-gradient-dark">
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <div class="d-flex justify-content-center align-items-center">
                                                            <button type="button" class="btn btn-link text-danger text-gradient px-3 mb-0"
                                                                ...
                                                                <i class="material-symbols-rounded text-lg me-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Delete Subject">delete</i>
                                                            </button>
                                                    
                                                            <a href="{{ route('admin.subject.edit', $subject) }}" class="btn btn-link text-info px-3 mb-0">
                                                                <i class="material-symbols-rounded text-lg me-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit Subject">edit_square</i>
                                                            </a>
                                                        </div>
                                                    </td>
                                                </tr>
