                ...
                <div class="card">
                    <div class="card-header pb-0 px-3">
                        <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between gap-3">
                            <h6 class="mb-2 mb-md-0">Manage Teacher</h6>
                            <div class="d-flex flex-column flex-sm-row align-items-start align-items-sm-center gap-2 w-100 w-md-auto">
                                ...
                                <a href="{{ route('admin.teacher.create') }}" class="btn mb-0 bg-gradient-dark w-100">
                                                        ...
                                                        <td class="align-middle text-center">
                                                            <div class="d-flex justify-content-center align-items-center flex-wrap gap-2">
                                                                <button type="button" class="btn btn-link text-danger text-gradient px-2 px-md-3 mb-0"
                                                                    ...
                                                                    <i class="material-symbols-rounded text-lg me-1 me-md-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Delete Teacher">delete</i>
                                                                </button>
                                                                <a href="{{ route('admin.teacher.edit', $teacher) }}" class="btn btn-link text-info px-2 px-md-3 mb-0">
                                                                    <i class="material-symbols-rounded text-lg me-1 me-md-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit Teacher">edit_square</i>
                                                                </a>
                                                            </div>
                                                        </td>
                                                    </tr>
